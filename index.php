...
<head>
    ...
    <!-- Page Title -->
    <title>Corner's Hustler || Home Page</title>
    <!-- Bootstrap CSS -->
                                ...
                                <div class="col-md-6">
                                    <div class="search-box2">
                                        <div class="search-box-title">
                                            ...
                                            <input class="search-form" type="text" name="location" style="height:55px;" required="true" placeholder="Eg:  Mpumalanga, Emalahleni"> 
                                        </div>
                                    </div>
                                </div>
                            </div>
