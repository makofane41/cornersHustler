...
$sql="insert into tbllisting(UserID,ListingTitle,listSub,Keyword,Category,Website,Address,TemporaryAddress,City,State,Country,Zipcode,OwnerName,Email,Phone,CompanyWebsite,OwnerDesignation,Company,FacebookLink,TweeterLink,Googlepluslink,Linkedinlink,Description,Logo) values(:lssemsuid,:listingtitle,:listSub,:keywords,:category,:website,:add,:tadd,:city,:state,:country,:zipcode,:ownername,:email,:phone,:comwebsite,:ownerdesi,:company,:flink,:twitterlink,:googlelink,:linkedin,:description,:logo)";
$query=$dbh->prepare($sql);
$query->bindParam(':lssemsuid',$lssemsuid,PDO::PARAM_STR);
$query->bindParam(':listingtitle',$listingtitle,PDO::PARAM_STR);
$query->bindParam(':listSub',$listSub,PDO::PARAM_STR);
...
<head>
    ...
    <!-- Page Title -->
    <title>Hustler Corner's || Listed</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="col-md-8">
                    <div class="listing-wrap">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Listing Subscription</label>
                                        <select  class="form-control add-listing_form" name="listSub" required="true">
                                        <option value="0">Free (default)</option>
                                        <option value="50">bronze Subs 50</option>
                                        <option value="75">Silver Subs 75</option>
                                        <option value="100">Gold Subs R100</option>
                                        </select>
                                    </div>
                                </div>
